...
class UserPreferencesRepositoryTest {
    ...
    @Test
    fun `isDarkTheme should emit initial value`() =
        runTest {
            // Given
    ...
    @Test
    fun `selectedLanguage should emit initial value`() =
        runTest {
            // Given
    ...
    @Test
    fun `saveThemePreference should update sharedPreferences`() =
        runTest {
            // When
    ...
    @Test
    fun `saveLanguagePreference should update sharedPreferences`() =
        runTest {
            // When
