...
fun ScannBottomSheet(
    ...
    AppWizardBottomSheet(
        ...
        config = AppWizardBottomSheetConfig(
            ...
            secondaryButtonText = if (state.currentStep == ScanStep.NAME || state.currentStep == ScanStep.CONTENT) stringResource(id = R.string.scan_again) else null
        ),
        actions = AppWizardBottomSheetActions(
            ...
            onSecondaryClick = if (state.currentStep == ScanStep.NAME || state.currentStep == ScanStep.CONTENT) actions.onScanAgainClick else null
        ),
        pagerContent = { page ->
