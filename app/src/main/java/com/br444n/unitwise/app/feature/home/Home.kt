        ...
        Column(
            ...
            ProductInputCard(
                ...
                actions = ProductInputActions(
                    onProductNameChange = { viewModel.updateProductA(uiState.productA.copy(productName = it)) },
                    onContentAmountChange = { viewModel.updateProductA(uiState.productA.copy(contentAmount = it)) },
            ...
            ProductInputCard(
                ...
                actions = ProductInputActions(
                    onProductNameChange = { viewModel.updateProductB(uiState.productB.copy(productName = it)) },
                    onContentAmountChange = { viewModel.updateProductB(uiState.productB.copy(contentAmount = it)) },
