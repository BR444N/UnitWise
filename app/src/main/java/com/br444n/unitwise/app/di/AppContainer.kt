...
class DefaultAppContainer(private val context: Context) : AppContainer {
    ...
    override val logOcrAttemptUseCase: LogOcrAttemptUseCase by lazy { LogOcrAttemptUseCase(telemetryLogger) }
    override val logParityToggledUseCase: LogParityToggledUseCase by lazy { LogParityToggledUseCase(telemetryLogger) }
    override val logListParityTypeUseCase: LogListParityTypeUseCase by lazy { LogListParityTypeUseCase(telemetryLogger) }
    override val logListSharedUseCase: LogListSharedUseCase by lazy { LogListSharedUseCase(telemetryLogger) }
}
